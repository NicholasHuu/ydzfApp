 ...
 * @describe: 时间格式化
 */
appMoudle.filter("formatDate",function () {
    return function (str) {
        var monthAndDay=str.split(",")[0];
        var month=monthAndDay.split(" ")[0];
        var monthVal;
        switch (month){
            case "Jan": monthVal=1;break;
            case "Feb": monthVal=2;break;
            case "Mar": monthVal=3;break;
            case "Apr": monthVal=4;break;
            case "May": monthVal=5;break;
            case "Jun": monthVal=6;break;
            case "Jul": monthVal=7;break;
            case "Aug": monthVal=8;break;
            case "Sep": monthVal=9;break;
